...
{
       0,    43,    43,    44,    47,    53,    59,    65,    71,    77,
      84,    91,    98,   105,   111,   117,   123
};
#endif
...
static const char *const yytname[] =
{
  ...
  "'*'", "'!'", "'('", "')'", "'a'", "'b'", "'c'", "'d'", "'A'", "'B'",
  "'C'", "'D'", "$accept", "input", "expr", YY_NULLPTR
};
...
{
      13,    14,     1,     2,    15,     3,     4,     5,     6,     7,
       8,     9,    10,    18,    19,    21,    22,    23,    24,    16,
      17,    18,    19,    19,     0,    20,    16,    17,    18,    19
};

static const yytype_int8 yycheck[] =
{
       1,     2,     7,     8,     0,    10,    11,    12,    13,    14,
      15,    16,    17,     5,     6,    16,    17,    18,    19,     3,
       4,     5,     6,     6,    -1,     9,     3,     4,     5,     6
};
...
yy_symbol_value_print (FILE *yyo,
                       yysymbol_kind_t yykind, YYSTYPE const * const yyvaluep, expr_t **root)
{
  FILE *yyoutput = yyo;
  YY_USE (yyoutput);
  YY_USE (root);
...
yydestruct (const char *yymsg,
            yysymbol_kind_t yykind, YYSTYPE *yyvaluep, expr_t **root)
{
  YY_USE (yyvaluep);
  YY_USE (root);
  if (!yymsg)
...
#line 47 "syntax.y"
               { // 这里要按优先级排
        (yyval.expr_t) = malloc(sizeof(expr_t));
        (yyval.expr_t)->left = NULL;
        (yyval.expr_t)->right = (yyvsp[0].expr_t);
        (yyval.expr_t)->op = '!';
    }
...
#line 53 "syntax.y"
                    {
        (yyval.expr_t) = malloc(sizeof(expr_t));
        (yyval.expr_t)->left = (yyvsp[-2].expr_t);
        (yyval.expr_t)->right = (yyvsp[0].expr_t);
        (yyval.expr_t)->op = '*';
    }
